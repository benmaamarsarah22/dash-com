...
namespace Anade.Khadamat.Web.ViewModels
{
    public class ActiviteForumVM
    {
        ...
        [StringLength(50, ErrorMessage = "Le lieu ne peut dépasser 200 caractères")]
        public string Lieu { get; set; }


        [Display(Name = "المنظمين")]
        [Required(ErrorMessage = "Les organisateurs sont obligatoires")]
        [StringLength(50, ErrorMessage = "Les organisateurs ne peuvent dépasser 300 caractères")]
        public string Organisateurs { get; set; }

        [Display(Name = "المشاركين")]
        [StringLength(50, ErrorMessage = "Les participants ne peuvent dépasser 500 caractères")]
